...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"LeatherSewingKit", DayZPlayerConstants.CMD_ACTIONFB_PATCHING_LEATHER_SEWING_KIT, true);//you can insert multiple ingredients this way
		InsertIngredient(0,"SewingKit", DayZPlayerConstants.CMD_ACTIONFB_PATCHING_SEWING, true);//you can insert multiple ingredients this way
		InsertIngredient(0,"TireRepairKit", DayZPlayerConstants.CMD_ACTIONFB_PATCHING_TIRE, true);//you can insert multiple ingredients this way
